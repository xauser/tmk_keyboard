...
const action_t PROGMEM actionmaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    ACTIONMAP_ANSI(
        ...
        ESC, A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,     TP2,
        LSFT,     Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,     RSFT,           UP,
        LCTL,LGUI,LALT,               TP1,                RALT,RGUI,APP, RCTL,      LEFT,DOWN,RGHT),
    ...
    ACTIONMAP_ANSI(
        ...
        TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,           TRNS,
        TRNS,MM1, TRNS,               SPC,                TRNS,TRNS,TRNS,TRNS,      TRNS,TRNS,TRNS),
    ...
    ACTIONMAP_ANSI(
        ...
        TRNS,TRNS,TRNS,               TRNS,               TRNS,LEFT,DOWN,RGHT,      TRNS,TRNS,TRNS),
    ...
    ACTIONMAP_ANSI(
        ...
        TRNS,MS_L,MS_D,MS_R,TRNS,TRNS,MS_L,MS_D,MS_U,MS_R,TRNS,TRNS,     TRNS,
        TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,BTN3,BTN2,TRNS,TRNS,TRNS,     TRNS,           MS_U,
        TRNS,TRNS,TRNS,               BTN1,               TRNS,TRNS,TRNS,TRNS,      MS_L,MS_D,MS_R),
    ...
    ACTIONMAP_ANSI(
        ...
        TRNS,DE4, DE5, DE6, LPRN,RPRN,LEFT,DOWN,UP,  RGHT,CIRC,TRNS,     TRNS,
        TRNS,     SY13,HK5, HK4, LBRC,RBRC,ASTR,MINS,TILD,EQL, PIPE,     TRNS,           TRNS,
        TRNS,TRNS,TRNS,               TRNS,               TRNS,TRNS,TRNS,TRNS,      TRNS,TRNS,TRNS),
    // layer 5: function layer 'enter' (momentary layer)
    ACTIONMAP_ANSI(
        TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,      TRNS,TRNS,TRNS,
        CL1, TG1, TG2, TG3, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,PWR,       TRNS,TRNS,TRNS,
        TRNS,VOLD,VOLU,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,      TRNS,TRNS,TRNS,
        TRNS,MPRV,MNXT,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,
        TRNS,     MPLY,MUTE,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,           TRNS,
        TRNS,TRNS,TRNS,               TRNS,               TRNS,TRNS,TRNS,TRNS,      TRNS,TRNS,TRNS),
};
