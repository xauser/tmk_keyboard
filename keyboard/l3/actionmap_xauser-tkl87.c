...
const action_t PROGMEM actionmaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    ACTIONMAP_TKL87(
        ...
        AMPR,1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, NO,  BSPC,INS, HOME,PGUP,
        TAB, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,BSLS,     DEL, END, PGDN,
        ESC, A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,NO,  TP2,
        LSFT,NO,  Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,     RSFT,          UP,
        RGUI,NO,  LALT,               TP1,                RALT,NO,  NO,  RCTL,     LEFT,DOWN,RGHT),
    ...
    ACTIONMAP_TKL87(
        ...
        MM1, NO,  TRNS,               SPC,                TRNS,NO,  NO,  TRNS,     TRNS,TRNS,TRNS),
    ...
    ACTIONMAP_TKL87(
        ...
        TRNS,NO,  TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,          TRNS,
        TRNS,NO,  TRNS,               TRNS,               TRNS,NO,  NO,  TRNS,     TRNS,TRNS,TRNS),
    // layer 3: mouse layer (toggle layer)
    ACTIONMAP_TKL87(
        TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,TRNS,TRNS,
        TRNS,BTN1,BTN3,BTN2,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,NO,  TRNS,TRNS,TRNS,TRNS,
        ...
        TRNS,NO,  TRNS,TRNS,TRNS,TRNS,TRNS,BTN3,BTN2,TRNS,TRNS,TRNS,     TRNS,          MS_U,
        TRNS,NO,  TRNS,               BTN1,               TRNS,NO,  NO,  TRNS,     MS_L,MS_D,MS_R),
    // layer 4: function layer 'space' (momentary layer)
    ACTIONMAP_TKL87(
        TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,TRNS,TRNS,
        GRV, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, NO,  PAUS,TRNS,TRNS,TRNS,
        TRNS,DE1, DE2, DE3, LCBR,RCBR,AMPR,HOME,INS, DEL, END, HK1, HK2, BTN3,     TRNS,TRNS,TRNS,
        TRNS,DE4, DE5, DE6, LPRN,RPRN,LEFT,DOWN,UP,  RGHT,TRNS,TRNS,NO,  TRNS,
        TRNS,NO,  SY13,HK5, HK4, LBRC,RBRC,ASTR,MINS,TILD,EQL, PIPE,     TRNS,          TRNS,
        TRNS,NO,  TRNS,               TRNS,               TRNS,NO,  NO,  TRNS,     TRNS,TRNS,TRNS),
    // layer 4: function layer 'enter' (momentary layer)
    ACTIONMAP_TKL87(
        TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,TRNS,TRNS,
        CL1, TG1, TG2, TG3, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,NO,  PWR, TRNS,TRNS,TRNS,
        ...
        TRNS,NO,  MPLY,MUTE,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,          TRNS,
        TRNS,NO,  TRNS,               TRNS,               TRNS,NO,  NO,  TRNS,     TRNS,TRNS,TRNS)
};
