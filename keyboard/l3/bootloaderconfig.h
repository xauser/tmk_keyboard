...
/* Use ESC as bootloader key.
 *
 * LZ-ERGO, ESC is on PC2, PA0
 *
 */
static inline void  bootLoaderInit(void)
{
    DDRA  &= ~0b00000001; // PA0 low for input
    PORTA |=  0b00000001; // PA0 high for pull-up
    DDRC  |=  0b00000100; // PC2 high for output
    PORTC &= ~0b00000100; // PC2 low
    _delay_us(10);
}
