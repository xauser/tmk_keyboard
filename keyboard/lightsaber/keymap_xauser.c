...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(
      ...
      CAPS,M,   TRNS,5,   TRNS,TRNS,LEFT,DOWN,UP,  RGHT,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,NO,
      TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,FN8, TRNS,TRNS,TRNS,TRNS,NO,  TRNS,TRNS,TRNS,TRNS,TRNS,
