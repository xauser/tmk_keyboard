...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KMAP(ESC,      F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, DEL, INS, PGUP,PGDN,
       ...
       LCTL,LGUI,LALT,               FN2,           FN3, RGUI,RCTL,LEFT,DOWN,RGHT,P0,  COMM),
  // layer 1: gaming
  KMAP(TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
       ...
       TRNS,NO,  TRNS,               SPC,           TRNS,NO,  TRNS,TRNS,TRNS,TRNS,TRNS,PDOT),
  ...
  KMAP(TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
       ...
       TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,FN6, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
