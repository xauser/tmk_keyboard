...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(
        ...
        LCTL,LGUI,LALT,               FN2,           FN3, RCTL,     LEFT,DOWN,RGHT),
    /* layer 1: gaming */
    KEYMAP(
        ...
        TRNS,NO,  TRNS,               SPC,           TRNS,TRNS,     TRNS,TRNS,TRNS),
    ...
    KEYMAP(
        GRV, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, PAUS,TRNS,
        ...
        TRNS,NO,  TRNS,TRNS,TRNS,TRNS,TRNS,FN6, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
