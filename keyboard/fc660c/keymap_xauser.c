...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* layer 1: gaming */
  KMAP(ESC, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     INS,
  ...
  /* layer 2: mouse */
  KMAP(FN6, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,
  ...
  KMAP(GRV, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, TRNS,     TRNS,
       ...
       TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,FN7, TRNS,TRNS,TRNS,TRNS,     TRNS,TRNS,
...
const action_t fn_actions[] PROGMEM = {
  ...
  [5] = ACTION_LAYER_MOMENTARY(LAYER_FUNCTIONS),
