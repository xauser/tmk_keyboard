...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(
    EQL, 1,   2,   3,   4,   5,   FN2,     FN3, 6,   7,   8,   9,   0,   MINS,
    TAB, Q,   W,   E,   R,   T,   FN4,     FN5, Y,   U,   I,   O,   P,   BSLS,
    FN1, A,   S,   D,   F,   G,                 H,   J,   K,   L,   SCLN,QUOT,
    LSFT,Z,   X,   C,   V,   B,   LBRC,    RBRC,N,   M,   COMM,DOT, SLSH,RSFT,
    LCTL,NO,  NO,  LALT,LGUI,                        RGUI,FN6, NO,  NO,  RCTL,
                             PSCR,PAUS,    LEFT,RGHT,
                                  PGUP,    UP,
                        FN7, DEL, PGDN,    DOWN,ENT, FN8),
  ...
  KEYMAP(
    ...
    TRNS,TRNS,Y,   P,   TRNS,TRNS,TRNS,    TRNS,TRNS,HOME,INS, DEL, END, F12,
    CAPS,M,   TRNS,5,   TRNS,TRNS,              LEFT,DOWN,UP,  RGHT,TRNS,TRNS,
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
    TRNS,TRNS,TRNS,TRNS,TRNS,                        TRNS,TRNS,TRNS,TRNS,TRNS,
                             TRNS,TRNS,    TRNS,TRNS,
                                  TRNS,    TRNS,
