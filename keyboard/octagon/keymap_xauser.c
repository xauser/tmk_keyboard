...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(\
        ...
        FN1, A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,SLCK,ENT, DEL,
    ...
    KEYMAP(\
        ...
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
        FN4, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
        TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
        TRNS,NO,  TRNS,               SPC,           TRNS,NO,  TRNS,TRNS,TRNS,TRNS),
    /* layer 2: first function layer */
    KEYMAP(\
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
        FN5, FN6, FN7, FN8, FN9, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
    ...
    KEYMAP(\
        ...
        CAPS,M,   TRNS,5,   TRNS,TRNS,LEFT,DOWN,UP,  RGHT,TRNS,TRNS,TRNS,TRNS,TRNS,
        TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,FN10,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
...
const action_t fn_actions[] PROGMEM = {
  ...
  [7]  = ACTION_BACKLIGHT_LEVEL(BACKLIGHT_RGBRED),
  [8]  = ACTION_BACKLIGHT_LEVEL(BACKLIGHT_RGBGREEN),
  [9]  = ACTION_BACKLIGHT_LEVEL(BACKLIGHT_RGBBLUE),
