...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP_B87(
       ...
       LCTL,LGUI,LALT,               FN2,                     FN3, APP, RCTL,  LEFT,DOWN,RGHT,  P0,       COMM),
  // layer 1: gaming
  KEYMAP_B87(
       ...
       TRNS,NO,  TRNS,               SPC,                     TRNS,NO,  TRNS,  TRNS,TRNS,TRNS,  TRNS,     TRNS),
  ...
  KEYMAP_B87(
       ...
       TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,WBAK,WH_D,WH_U,WFWD,TRNS,TRNS,TRNS,TRNS,  TRNS,TRNS,TRNS,  TRNS,TRNS,TRNS,TRNS,
  ...
  KEYMAP_B87(
       TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,  TRNS,TRNS,TRNS,  TRNS,TRNS,TRNS,TRNS,
       GRV, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,PGUP,  TRNS,TRNS,TRNS,  TRNS,TRNS,TRNS,TRNS,
       TRNS,TRNS,Y,   P,   PSCR,SLCK,PAUS,HOME,INS, DEL, END, TRNS,TRNS,PGDN,  TRNS,TRNS,TRNS,  TRNS,TRNS,TRNS,TRNS,
       CAPS,M,   TRNS,5,   TRNS,TRNS,LEFT,DOWN,UP,  RGHT,TRNS,TRNS,     TRNS,                   TRNS,TRNS,TRNS,
       TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,FN6, PGDN,PGUP,TRNS,TRNS,     TRNS,       TRNS,       TRNS,TRNS,TRNS,TRNS,
