...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP_B87(
       ...
       LCTL,LGUI,LALT,               SPC,                     FN1, APP, RCTL,  LEFT,DOWN,RGHT,  P0,       COMM),
  // layer 1: space fn
  KEYMAP_B87(\
  ...
  KEYMAP_B87(\
       ...
       TRNS,TRNS,Y,   P,   PSCR,SLCK,PAUS,HOME,INS, DEL, END, VOLD,VOLU,MUTE,  TRNS,TRNS,TRNS,  TRNS,TRNS,TRNS,TRNS,
       CAPS,TRNS,TRNS,TRNS,TRNS,TRNS,LEFT,DOWN,UP,  RGHT,MPRV,MNXT,     MPLY,                   TRNS,TRNS,TRNS,
       TRNS,     SLEP,TRNS,TRNS,TRNS,TRNS,FN8, PGDN,PGUP,TRNS,TRNS,     TRNS,       TRNS,       TRNS,TRNS,TRNS,TRNS,
